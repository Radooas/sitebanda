  ...
  head: () => ({
    meta: [
      { title: "Zero82 Produções — Música ao vivo para seu evento" },
      {
        name: "description",
        content:
          "Bandas e serviços musicais sob medida para casamentos, eventos corporativos e festas. Repertório premium com qualidade profissional.",
      },
      { property: "og:title", content: "Zero82 Produções — Música ao vivo para seu evento" },
      {
        property: "og:description",
        content: "Bandas e serviços musicais sob medida para os momentos mais importantes.",
      },
    ],
  }),
  component: Index,
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative container mx-auto px-6 py-32 md:py-48 text-center">
            <span className="inline-block animate-fade-up text-xs uppercase tracking-[0.3em] text-primary mb-6">
              Música ao vivo • Desde 2014
            </span>
            <h1 className="animate-fade-up font-display text-5xl md:text-7xl lg:text-8xl font-bold leading-[1.05] max-w-4xl mx-auto">
              A trilha sonora dos seus{" "}
              <span className="text-gradient-gold">momentos inesquecíveis</span>
            </h1>
            <p className="animate-fade-up mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Bandas, DJs e produção musical completa para casamentos, eventos corporativos e festas
              exclusivas.
            </p>
            <div className="animate-fade-up mt-10 flex flex-wrap gap-4 justify-center">
              <Link
                to="/bandas"
                className="inline-flex items-center gap-2 rounded-full bg-gradient-gold px-7 py-3.5 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-gold)] hover:scale-105 transition-transform"
              >
                Ver Bandas <ArrowRight className="h-4 w-4" />
              </Link>
              <Link
                to="/servicos"
                className="inline-flex items-center gap-2 rounded-full border border-border px-7 py-3.5 text-sm font-semibold hover:bg-card transition-colors"
              >
                Nossos Serviços
              </Link>
            </div>
        ...
        <section className="container mx-auto px-6 py-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {bands.map((band) => (
              <article
                key={band.slug}
                className="group rounded-2xl overflow-hidden bg-card border border-border hover:border-primary/50 transition-all hover:-translate-y-1 hover:shadow-[var(--shadow-elegant)]"
              >
          ...
          <div className="rounded-3xl bg-card border border-border p-10 md:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="font-display text-4xl md:text-5xl font-bold max-w-2xl mx-auto">
                Pronto para criar uma experiência{" "}
              ...
              <Link
                to="/contato"
                className="mt-8 inline-flex items-center gap-2 rounded-full bg-gradient-gold px-7 py-3.5 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-gold)] hover:scale-105 transition-transform"
              >
